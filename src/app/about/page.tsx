      ...
      <div className="relative">
        ...
        <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              We believe everyone deserves to experience the magic of the mountains.
              SkiLesson.ai brings world-class instruction to your living room, so
              when you finally stand at the summit, you&apos;re ready.
            </motion.p>
          </div>
        </section>
        ...
        <section className="pb-16 px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="relative aspect-[21/9] w-full overflow-hidden rounded-2xl">
              <Image
                src="https://images.unsplash.com/photo-1548587087-41854e994853?q=80&w=2940&auto=format&fit=crop"
              ...
              <div className="absolute bottom-6 left-6 sm:bottom-8 sm:left-8">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sky-400">Where We Teach</p>
                <p className="mt-1 text-lg font-bold text-white" style={{ fontFamily: 'var(--font-plus-jakarta-sans)' }}>
        ...
        <section className="pb-24 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-400 text-lg mb-10">
              Our curriculum aligns with the highest standards in snow sports instruction.
            </p>
